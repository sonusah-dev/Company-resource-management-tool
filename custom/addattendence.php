           ...
           <div class="col-12">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <form class="needs-validation"  method="post" action="phpscript/insertattendence.php">
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom01"><b>Student</b><span class="text-danger"> *</span></label>
                                    <input type="text" name="student" class="form-control" id="validationCustom01" placeholder=""  required="">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="batch" class="form-control" id="validationCustom01" placeholder=""  required="">
                                        <div class="valid-feedback">

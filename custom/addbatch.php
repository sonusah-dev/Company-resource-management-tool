            ...
            <div class="col-12">
                ...
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <form class="needs-validation" novalidate="" action="phpscript/insertbatch.php" method="post">

                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                <label for="validationCustom01"><b>Batch Code</b></label>
                                <input type="text" name="code" class="form-control " id="validationCustom01" placeholder="" required="">
                            ...
                            <div class="form-row">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="time" name="start_time" class="form-control" id="validationCustom01" placeholder="">
                                        <div class="valid-feedback">
                                            Please provide a valid time.
                                        </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="time" name="end_time" class="form-control" id="validationCustom01" placeholder="">
                                        <div class="valid-feedback">
                                            Please provide a valid time.
                                        </div>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="date" name="start_date" class="form-control" id="validationCustom01" placeholder="">
                                        <div class="valid-feedback">
                            ...
                            <div class="form-row"> 
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="date" name="end_date" class="form-control" id="validationCustom01" placeholder="" >
                                        <div class="valid-feedback">
                                            Please provide a valid date.
                                        </div>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="completed" class="form-control" id="validationCustom01" placeholder="" >
                                        <div class="valid-feedback">

                        ...
                        <form class="needs-validation"  method="post" action="phpscript/updateattendence.php?id=<?php echo $row['id'];?>">
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" name="student" value="<?php echo $row['student']; ?>" class="form-control" id="validationCustom01" placeholder=""  required>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" name="batch" value="<?php echo $row['batch_id']; ?>" class="form-control" id="validationCustom01" placeholder=""  required>
                                        <div class="valid-feedback">

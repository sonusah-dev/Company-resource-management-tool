        ...
        <?php endif ?> 
          <div class="row">
            ...
            <div class="col-12 mt-5">
              <div class="card">
                <div class="card-body">
                  <h4 class="header-title">Student Attendence Details</h4>
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            $row2 = mysqli_fetch_array(mysqli_query($conn, "SELECT batch_code FROM batch WHERE id = $batch_id"))
                            ?>
                            <td><?php echo $row2['batch_code']; ?></td>
                            <td><?php echo $row['attendance_date']; ?></td>
                            <td>
                              <ul class="d-flex justify-content-center">
                                <li class="mr-3">
                                  <a
                                    href="editattendence.php?id=<?php echo $row['id']; ?>"
                                    class="text-primary"
                                ...
                                <li>
                                  <a
                                    href="phpscript/deleteattendence.php?id=<?php echo $row['id']; ?>"
                                    class="text-danger"
                                    ><i class="ti-trash"></i
                                  ></a>
                                </li>

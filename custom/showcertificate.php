                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_array($resultset)) : ?>
                          <tr>
                            ...
                            <?php
                            $course_id = $row['course_id'];
                            $row3 = mysqli_fetch_array(mysqli_query($conn, "SELECT course_category FROM course WHERE id = $course_id"))
                            ?>
                            <td><?php echo $row3['course_category']; ?></td>
                            <td>
                              <?php
                            ...
                            <td>
                              <ul class="d-flex justify-content-center">
                                <li class="mr-3">
                                  <a href="editcertificate.php?id=<?php echo $row['id']; ?>" class="text-primary"><i class="fa fa-edit"></i></a>
                                </li>
                                <li>
                                  <a href="phpscript/deletecertificate.php?id=<?php echo $row['id']; ?>" class="text-danger"><i class="ti-trash"></i></a>
                                </li>
                              </ul>
                            </td>
                          </tr>

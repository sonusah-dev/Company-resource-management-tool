                                    ...
                                    <table id="dataTable" class="text-center">
                                        ...
                                        <?php while ($row = mysqli_fetch_array($resultset)) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                <?php   if($row['profile_status'] == 0) : echo 'Active';
                                                ...
                                                <td>
                                                    <ul class="d-flex justify-content-center">
                                                        <li class="mr-3"><a href="editemployee.php?id=<?php echo $row['id']; ?>" class="text-secondary"><i class="fa fa-edit"></i></a></li>
                                                        <li><a href="phpscript/deleteemployee.php?id=<?php echo $row['id'];?>" class="text-danger"><i class="ti-trash"></i></a></li>
                                                    </ul>
                                                </td>
                                            </tr>
                                        <?php endwhile ?>   

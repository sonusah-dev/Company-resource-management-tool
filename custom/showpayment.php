                      ...
                      <tbody>
                        ...
                        while ($row = mysqli_fetch_array($resultset)) : ?>
                          <tr>
                            ...
                            <td>
                              <?php echo $row['payment_reference_number']; ?>
                            </td>
                            <td>
                              <?php
                            ...
                            <td>
                              <ul class="d-flex justify-content-center">
                                <li class="mr-3">
                                  <a href="editpayment.php?id=<?php echo $row['id']; ?>" class="text-primary"><i class="fa fa-edit"></i></a>
                                </li>
                                <li>
                                  <a href="phpscript/deletepayment.php?id=<?php echo $row['id']; ?>" class="text-danger"><i class="ti-trash"></i></a>
                                </li>
                              </ul>
                            </td>
                          </tr>

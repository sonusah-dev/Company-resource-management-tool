                        ...
                        <tr>
                          ...
                          <td>
                            <ul class="d-flex justify-content-center">
                              <li class="mr-3">
                                <a href="editstudent.php?id=<?php echo $row['id']; ?>" class="text-primary"><i class="fa fa-edit"></i></a>
                              </li>
                              <li>
                                <a href="phpscript/deletestudent.php?id=<?php echo $row['id']; ?>" class="text-danger"><i class="ti-trash"></i></a>
                              </li>
                            </ul>
                          </td>
                        </tr>
